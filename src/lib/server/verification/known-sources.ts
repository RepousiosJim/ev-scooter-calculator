...
export const knownSources: Record<string, KnownSource[]> = {
	...
	nami_klima: [
		{ name: 'FluidFreeRide', type: 'retailer', url: 'https://fluidfreeride.com/products/nami-klima' },
	],
	apollo_city_2024_pro: [
		{ name: 'Electric Scooter Guide', type: 'review', url: 'https://electric-scooter.guide/reviews/apollo-city-pro-review/' },
	],
	apollo_go: [
		// ESG review removed, apolloscooters.com is JS-only — no verified working URL
	],
	niu_kqi_air: [
		{ name: 'NIU Official', type: 'manufacturer', url: 'https://global.niu.com/product/kqi-air' },
	],
	navee_gt3: [
		{ name: 'NAVEE Official', type: 'manufacturer', url: 'https://www.naveetech.com/gt3' },
	],
	segway_e2_pro: [
	...
	nami_burn_e_2_max: [
		...
		{ name: 'Electric Scooter Guide', type: 'review', url: 'https://electric-scooter.guide/reviews/nami-burn-e-2-max-review/' },
	],
	segway_gt2: [
		{ name: 'Segway Store', type: 'manufacturer', url: 'https://store.segway.com/segway-superscooter-gt2' },
	],
	segway_gt1: [
		{ name: 'Segway Store', type: 'manufacturer', url: 'https://store.segway.com/segway-superscooter-gt1' },
	],
	...
	segway_max_g2: [
		...
		{ name: 'Electric Scooter Guide', type: 'review', url: 'https://electric-scooter.guide/reviews/segway-max-g2-review/' },
	],
	niu_kqi3_max: [
		// NIU site restructured, product not found on new domain
	],
	gotrax_g4: [
		{ name: 'Gotrax Official', type: 'manufacturer', url: 'https://gotrax.com/products/g4-electric-scooter-for-adults' },
	...
	emove_cruiser_s: [
		...
		{ name: 'Electric Scooter Guide', type: 'review', url: 'https://electric-scooter.guide/reviews/emove-cruiser-review/' },
	],
	xiaomi_4_ultra: [
		// Xiaomi site is JS-rendered — no static HTML specs
	],
	...
	vsett_9_plus: [
		{ name: 'RevRides', type: 'retailer', url: 'https://revrides.com/products/vsett-9-plus' },
	],
	vsett_8: [
	...
	hiboy_s2_pro: [
		{ name: 'Hiboy Official', type: 'manufacturer', url: 'https://www.hiboy.com/products/hiboy-s2-pro-electric-scooter' },
	],
	niu_kqi2_pro: [
		// NIU site restructured, product not found on new domain
	],
	unagi_voyager: [
		{ name: 'Electric Scooter Guide', type: 'review', url: 'https://electric-scooter.guide/reviews/unagi-voyager-review/' },
	],
	uscooters_gt_sport: [
		// Product removed from uscooters.com — no verified working URL
	],
	inokim_light_2: [
		{ name: 'Electric Scooter Guide', type: 'review', url: 'https://electric-scooter.guide/reviews/inokim-light-2-review/' },
	],
	dualtron_thunder_3: [
...
/** Get known sources for a scooter, or empty array if none configured */
export function getKnownSources(scooterKey: string): KnownSource[] {
	return knownSources[scooterKey] || [];
}
