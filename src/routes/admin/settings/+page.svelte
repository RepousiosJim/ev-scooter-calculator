...
<div class="space-y-6 max-w-2xl">
  ...
  <div class="bg-[#12121a] border border-gray-800 rounded-xl p-5 space-y-4">
    ...
    <div class="space-y-3">
      <div>
        <label for="gemini-api-key" class="text-xs text-gray-400 block mb-1">Gemini API Key</label>
      ...
      <div>
        <label for="gemini-model" class="text-xs text-gray-400 block mb-1">Gemini Model</label>
        <select
          id="gemini-model"
    ...
    <div class="space-y-3">
      <div>
        ...
        <p class="text-[10px] text-gray-500 mt-0.5">
          Fields reaching this confidence level will be auto-marked as verified.
        </p>
      </div>

      <div>
        <label for="outdated-days" class="text-xs text-gray-400 block mb-1">
  ...
  <div class="bg-[#12121a] border border-gray-800 rounded-xl p-5 space-y-4">
    ...
    <div class="space-y-3">
      <div>
        <label for="batch-delay" class="text-xs text-gray-400 block mb-1">
      ...
      <div>
        <label for="max-scrapes" class="text-xs text-gray-400 block mb-1">
