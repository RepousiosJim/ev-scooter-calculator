...
export default {
	...
	safelist: [
		// Grade tier backgrounds and borders (rankings page — built from tierMeta object)
		'bg-amber-500/[0.06]',
		'border-amber-500/25',
		'bg-emerald-500/[0.06]',
		...
		'bg-blue-500/[0.04]',
		'border-blue-500/20',
		// Grade tier text and bar colors
		'text-amber-300',
		'bg-amber-400',
		'text-emerald-400',
		'bg-emerald-400',
		...
		'text-rose-400',
		'bg-rose-400',
		// Grade badge compound classes (badgeColors object)
		'bg-amber-500/20',
		'border-amber-500/40',
		'bg-emerald-500/20',
	...
	theme: {
		extend: {
			...
			fontSize: {
				...
				'label-lg': [
					'14px',
					{ lineHeight: '20px', fontWeight: '600', letterSpacing: '0.05em', textTransform: 'uppercase' },
				],
				label: ['13px', { lineHeight: '20px', fontWeight: '600', letterSpacing: '0.05em', textTransform: 'uppercase' }],
				'label-sm': [
					'11px',
					{ lineHeight: '16px', fontWeight: '600', letterSpacing: '0.05em', textTransform: 'uppercase' },
				],
				// Data/Number sizes
